...
public class BluetoothChatService {
    ...
    public synchronized void start() {
        ...
        if (mConnectThread != null) {
            Log.d("B.chat.serv-5", "start-if1 (cancelamos todos los intentos de abrir conexion con thread)");
        ...
        if (mConnectedThread != null) {
            Log.d("B.chat.serv-6", "start-if2 (cancelamos todos los threads con connexion)");
        ...
        if (mSecureAcceptThread == null) {
            Log.d("B.chat.serv-6", "start-if3 (empezar el thread para escuchar el BluetoothServerSocket)");
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    Log.e( "B.chat.serv-11-ERROR", "Socket Type: " + mSocketType + "accept() failed", e);
                    break;
                }

                // If a connection was accepted
                if (socket != null) {
                    Log.e( "B.chat.serv-12", "if-si se ha aceptado una conexion");
            ...
            Log.i("$$ Error $$", "END mAcceptThread, socket Type: " + mSocketType);

        }

        public void cancel() {
            Log.d("$$ Error $$", "Socket Type" + mSocketType + "cancel " + this);
            try {
                mmServerSocket.close();
            } catch (IOException e) {
                Log.e("$$ Error $$", "Socket Type" + mSocketType + "close() of server failed", e);
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            Log.i("$$ Error $$", "BEGIN mConnectThread SocketType:" + mSocketType);
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Log.d("$$ Error $$", "connected, Socket Type:" + socketType);
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            Log.d("$$ Error $$", "create ConnectedThread: " + socketType);
            mmSocket = socket;
        ...
        public void run() {
            Log.i("$$ Error $$", "BEGIN mConnectedThread");
    ...
    */
    ...
    public synchronized void connect(BluetoothDevice device, boolean secure) {
        Log.d(" $$ CONECTADO $$", "connect to: " + device);
